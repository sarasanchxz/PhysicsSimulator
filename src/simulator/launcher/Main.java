...
public class Main {
	...
	private static String _gui = null;
	...
	private static void parseInFileOption(CommandLine line) throws ParseException {
		//revisar modo gui ya que este parse es opcional en ese modo
		_inFile = line.getOptionValue("i");
		if (_inFile == null && "batch".equals(_gui)) {
	...
	private static void parseModeOption(CommandLine line) throws ParseException {
		...
		if (!"batch".equals(mode) && !"gui".equals(mode)) {
	...
	private static void startBatchMode() throws Exception {
		...
		Controller c = new Controller(_bodyFactory, _forceLawsFactory, ps);
		c.loadData(in);
		c.run(_steps, out);
		in.close();
		if (_outFile != null) {
	...
	private static void startGuiMode() throws Exception
	{
		...
		InputStream in = new FileInputStream (new File(_inFile));
		Controller ctrl = new Controller(_bodyFactory, _forceLawsFactory, ps);
